...
if [ ! -f "/home/ark/.config/.update${RIDGEK_DATE}" ]; then
	...
	if [ -f "/home/ark/arkosupdate${RIDGEK_DATE}.zip" ]; then
		# Backup user's retroarch.cfg files
		# @todo Remove this if option to select retroarch save location becomes available
		cp -v /home/ark/.config/retroarch/retroarch.cfg /home/ark/.config/retroarch/retroarch.cfg.bak | tee -a "$LOG_FILE"
		cp -v /home/ark/.config/retroarch32/retroarch.cfg /home/ark/.config/retroarch32/retroarch.cfg.bak | tee -a "$LOG_FILE"
